 ...
 */
class AdapterMovie: PagedListAdapter<ResponseMovies.ResultsItem,AdapterMovie.Holder>(object :
    DiffUtil.ItemCallback<ResponseMovies.ResultsItem>(){
    /**
     ...
     */
    override fun areItemsTheSame(oldItem: ResponseMovies.ResultsItem, newItem: ResponseMovies.ResultsItem): Boolean {
     ...
     */
    override fun areContentsTheSame(oldItem: ResponseMovies.ResultsItem, newItem: ResponseMovies.ResultsItem): Boolean {
    ...
    class Holder(var view: View): RecyclerView.ViewHolder(view) {
        ...
        fun bind(item: ResponseMovies.ResultsItem?) {
